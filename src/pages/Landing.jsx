...
const TESTIMONIALS = [
  {
    ...
    name: 'Sarah M.', title: 'HR Director, TechCorp', initials: 'SM', color: 'bg-[#1B2D5B]',
  },
  {
    quote: 'Finally, a childcare benefit that actually works. I saved over $4,800 last year using pre-tax dollars.',
    name: 'James L.', title: 'Software Engineer & Parent', initials: 'JL', color: 'bg-[#2E9E4F]',
  },
  {
    quote: 'The platform is incredibly easy to set up. Our whole benefits package feels more competitive now.',
    name: 'Maria R.', title: 'People Operations, StartupCo', initials: 'MR', color: 'bg-[#E8A020]',
  },
]
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12">
          <div className="bg-[#f0f4ff] rounded-3xl p-8">
            ...
            <Link to="/employers" className="inline-block mt-6 text-sm font-semibold text-[#2E9E4F] hover:underline">
          ...
          <div className="bg-[#f0fff5] rounded-3xl p-8">
            ...
            <Link to="/employees" className="inline-block mt-6 text-sm font-semibold text-[#2E9E4F] hover:underline">
              Learn more for employees →
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 bg-[#f8fafc]">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <button onClick={onSignup} className="mt-8 bg-[#1B2D5B] text-white font-semibold px-6 py-3 rounded-xl hover:bg-[#152347] transition-colors">
              See the Platform
            </button>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {TESTIMONIALS.map(t => (
              <div key={t.name} className="bg-[#f8fafc] rounded-2xl p-6 border border-gray-100">
                <div className="flex mb-3">{[...Array(5)].map((_, i) => <span key={i} className="text-[#E8A020] text-sm">★</span>)}</div>
